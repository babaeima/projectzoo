...
public class Managereditgrafic extends JPanel {
    public int i=0;
    public Managereditgrafic(int im) {
        Person p = new Person() {
            @Override
        ...
        if (im < Manager.manager.size()) {
            setMinimumSize(new Dimension(800, 800));
            setPreferredSize(new Dimension(800, 800));
            setBackground(Color.darkGray);

            JLabel name = new JLabel("Name: " + Manager.manager.get(im).Name);
            ...
            JLabel lastname = new JLabel("LastName: " + Manager.manager.get(im).lastname);
            ...
            JLabel username = new JLabel("Username: " + Manager.manager.get(im).Username);
            ...
            JLabel password = new JLabel("Password: " + Manager.manager.get(im).password);
            ...
            JLabel phonenumber = new JLabel("Phonenumber: " + Manager.manager.get(im).phonenumber);
            ...
            JLabel address = new JLabel("Address: " + Manager.manager.get(im).Address);
            ...
            JLabel email = new JLabel("Email: " + Manager.manager.get(im).mail);
            ...
            JLabel wage = new JLabel("Wage: " + Manager.manager.get(im).wage);
            ...
            save.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent actionEvent) {
                    if (enteremail.getText().matches("[a-zA-Z]+[a-zA-Z0-9]*[@][g][m][a][i][l][.][c][o][m]") && enterphonenumber.getText().matches("[0][9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]")) {
                        ...
                        Manager.manager.get(im).Name = entername.getText();
                        Manager.manager.get(im).lastname = enterlastname.getText();
                        Manager.manager.get(im).Username = enterusername.getText();
                        ...
                        Manager.manager.get(im).phonenumber = enterphonenumber.getText();
                        Manager.manager.get(im).Address = enteraddress.getText();
                        Manager.manager.get(im).mail = enteremail.getText();
                        Manager.manager.get(im).wage = enterwage.getText();
                        m.save_arraylists_to_file();
                        save_status.setForeground(Color.GREEN);
                        save_status.setText("Edit successfull");
                        p.setreport("manager " + im, "edit");
                    } else {
